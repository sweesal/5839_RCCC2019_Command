...
public class BallGrabbing extends CommandGroup {
  /**
   * Add your docs here.
   */
  public BallGrabbing() {
    if(Robot.claw.ballCollectorFlag){
      addParallel(new GetTheBallReturnToNormalState());
    }else{
      addParallel(new GrabTheBallOnTheField());
    }
    // Add Commands here:
